...
import 'package:flutter_grocery/view/screens/address/widget/map_location_permission_dialog.dart';
...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void initState() {
    ...
    if (widget.isEnableUpdate && widget.address != null) {
      ...
      _contactPersonNameController.text = Provider.of<ProfileProvider>(context, listen: false).isLoading ? '' : '${Provider.of<ProfileProvider>(context, listen: false).userInfoModel.fName ?? ''}'
          ' ${Provider.of<ProfileProvider>(context, listen: false).userInfoModel.lName ?? ''}';
      _contactPersonNumberController.text = Provider.of<ProfileProvider>(context, listen: false).isLoading ? '' : Provider.of<ProfileProvider>(context, listen: false).userInfoModel.phone ?? '';
    }
  }
