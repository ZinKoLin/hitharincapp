  ...
  void _loadData(BuildContext context) async {
    if (flag == 0) {
      ...
      Provider.of<ProductProvider>(context, listen: false).initCategoryProductList(
        categoryModel.id.toString(), context, Provider.of<LocalizationProvider>(context, listen: false).locale.languageCode,
      );
                        ...
                        return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                          ...
                          productProvider.categoryProductList.length > 0
                              ...
                              child: productProvider.hasData
                                  ? Padding(
                                    padding: EdgeInsets.symmetric(horizontal: Dimensions.PADDING_SIZE_SMALL),
                                    // child: WebProductShimmer(isEnabled: productProvider.categoryProductList == null),
                         ...
                         // for product total item and calculation
                          ...
                          /// this feature is remove .....
                        /*  ResponsiveHelper.isDesktop(context) ? SizedBox.shrink() : Provider.of<CartProvider>(context, listen: false).cartList.length > 0 ? InkWell(
                              onTap: () {
