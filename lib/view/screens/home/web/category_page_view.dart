                            ...
                            child: InkWell(
                              ...
                              onTap: (){
                                Navigator.of(context).pushNamed(
                                  RouteHelper.getCategoryProductsRoute(categoryProvider.categoryList[index].id),
                                  arguments: CategoryProductScreen(categoryModel: categoryProvider.categoryList[_currentIndex]),
                                );
                                },
                              child: TextHover(
                                builder: (hovered) {
