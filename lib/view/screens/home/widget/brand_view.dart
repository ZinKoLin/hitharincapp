...
class BrandView extends StatefulWidget {
  @override
  State<BrandView> createState() => _BrandView();
}
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Align(
                    ...
                    child: TitleWidget(title: "Brand"),
                  ),

                if (ResponsiveHelper.isDesktop(context)) CategoriesWebView() else GridView.builder(
                        itemCount: category.categoryList.length > 2  ? 3: category.categoryList.length,
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: index != 5 ? ClipRRect(
                                  ...
                                  alignment: Alignment.center,
                                  child: Text('${category.categoryList.length - 3}+', style: poppinsRegular.copyWith(color: Theme.of(context).cardColor)),
                                ),
                              ),
                            ),
                            Expanded(
